...
class SimpleStorageService:
    ...
    def read_object(object_name: str, decode: bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        ...
        try:
            ...
            conv_func = lambda: StringIO(func()) if make_readable is True else func() # many Python libraries (like Pandas) expect a file, not a string. so StringIO converts a string into something that behaves like a file.
